Feature: Destination redirection
  ...
  Scenario: As a Bakery user, I want my destination to carry through login on D6
    Given I visit "http://d6.masterd6.vbox/user/login?destination=filter/tips"
  ...
  Scenario: As a Bakery user, I want my destination to carry through registration on D6
    Given I visit "http://d6.masterd6.vbox/user/register?destination=filter/tips"
